...
# Run tests (76 test packages, all pass)
...
- **Upstream target**: v1.10.0 (June 2026) — ✅ synced (2909ef1). ~451 commits merged across 24 syncs.
...
- **Tests**: 76 test packages, ~2,250+ test cases across all packages. `go test ./...`
