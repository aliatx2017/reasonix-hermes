...
- **Upstream synced**: `v1.8.x` (commit bc83374, 2026-06-16). 12 syncs total — 8 new commits this session (interactive CLI default, desktop updater flow, settings refinements, site docs refresh). Previous sync: 29ffd31.
