...
description: Reference for writing and editing skills well — vocabulary and principles that make a skill predictable (leading words, information hierarchy, pruning, failure modes).
---

---
name: writing-great-skills
description: Reference for writing and editing skills well — the vocabulary and principles that make a skill predictable. Use when creating, editing, or reviewing a SKILL.md.
runAs: inline
scope: project
---
...
When user-invoked skills multiply past what you can remember, cure it with a **router skill**: one user-invoked skill that names the others and when to reach for each.
...
- **Premature completion** — ending a step before it's genuinely done, attention slipping to _being done_. Defence: sharpen the completion criterion first; only if it is irreducibly fuzzy and you observe the rush, hide the post-completion steps by splitting.
