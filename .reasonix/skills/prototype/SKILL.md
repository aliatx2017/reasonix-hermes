---
name: prototype
description: Build a throwaway prototype to flesh out a design — logic terminal app or UI variants, one command to run, delete when done.
---
...
2. **One command to run.** Whatever the project's existing task runner supports — `go run`, `pnpm <name>`, `python <path>`, etc. The user must be able to start it without thinking.
