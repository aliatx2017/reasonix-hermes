  ...
  if (loading) {
    return (
      <section className="settings-section">
        ...
        <p className="settings-section__desc" style={{ color: "var(--color-text-muted)" }}>Loading…</p>
      </section>
    );
  }
  ...
  return (
    <section className="settings-section">
      ...
      <p className="settings-section__desc">
        Detected agent behaviour patterns and multi-turn trajectories.
        Enable <code>[learn]</code> in config and use <code>/learn</code> in chat.
      </p>

      {/* Patterns */}
      {patterns.length === 0 ? (
        <EmptyHint icon={<Lightbulb size={24} />}
            ...
            <div key={p.name} style={{
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 4 }}>
                ...
                <span style={{
                  ...
                  background: p.confidence >= 4 ? "var(--color-green-subtle)" : "var(--color-yellow-subtle)",
              ...
              {p.draft && (
                <pre style={{
                  fontSize: 11, margin: 0, padding: "6px 8px", borderRadius: 4,
