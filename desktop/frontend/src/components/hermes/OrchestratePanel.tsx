  ...
  return (
    <section className="settings-section">
      ...
      <p className="settings-section__desc">
        Multi-agent workflows available as slash commands in the CLI chat.
        Type <code>/chain</code>, <code>/pair</code>, or <code>/ci-fix</code> followed by your task.
      </p>
        ...
        {workflows.map((w) => (
          <div key={w.label} style={{
            ...
            <div style={{
              ...
              background: "var(--color-code-bg)", fontFamily: "var(--mono)", fontSize: 12,
      ...
      <div style={{
        ...
        <strong>Tip:</strong> These run in the CLI chat TUI. For desktop orchestration,
        open a session in the terminal and use the slash commands — results appear
        inline in your chat.
      </div>
    </section>
  );
