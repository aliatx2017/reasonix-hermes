...
ok(
  themeSource.includes('if (theme !== "auto")') &&
    themeSource.includes('clearAutoThemeBackgroundListener();'),
  'non-auto themes clear the auto listener',
);
ok(
  themeSource.includes('if (currentTheme === "auto"') &&
    themeSource.includes('syncNativeWindowBackground("auto")'),
