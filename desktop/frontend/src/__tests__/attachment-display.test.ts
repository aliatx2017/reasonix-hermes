...
import {
  ...
  replaceAttachmentRefsForDisplay,
  restoreAttachmentRefsForSubmit,
...
eq(
  replaceAttachmentRefsForDisplay(
    'see @[DS30000.sl2](.reasonix/attachments/clipboard-20260610-121238.444775-000002.sl2)',
  ),
...
eq(
  restoreAttachmentRefsForSubmit(
    'review @[DS30000.sl2](.reasonix/attachments/clipboard-20260610-121238.444775-000002.sl2), then @[park.png](.reasonix/attachments/clipboard-20260610-121238.444775-000001.png)',
  ),
...
eq(
  baseName('C:\\Users\\Abyss\\Desktop\\DS30000.sl2'),
  'DS30000.sl2',
  'extracts Windows path basenames',
);
