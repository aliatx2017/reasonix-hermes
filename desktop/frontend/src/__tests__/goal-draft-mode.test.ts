...
eq(keepGoalDraftMode(true, ''), true, 'draft flag is retained while goal text is empty');

eq(keepGoalDraftMode(true, 'ship the fix'), false, 'draft flag clears after a real goal exists');
