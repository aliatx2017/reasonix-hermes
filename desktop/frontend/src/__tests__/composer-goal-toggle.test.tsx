...

{
  ...
  const goalButton = document.querySelectorAll('.composer-intent-menu__item')[1] as
    | HTMLButtonElement
    | undefined;
  ...
  eq(
    calls.setCollaborationMode.join(','),
    'goal',
    'enabling goal mode switches only the collaboration axis',
  );
