...
export const en = {
  ...
  "settings.coldResumePruneHint": "When a session is reopened after the provider cache expires (~24h idle), drop stale tool results to cheapen the restart. Turn off to keep full history.",
