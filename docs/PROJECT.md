...
**Reasonix Hermes** is an extended fork of [esengine/deepseek-reasonix](https://github.com/esengine/deepseek-reasonix) (synced to v1.8.x). We build on upstream's config-driven, plugin-driven Go core and add cross-agent connectivity, persistent memory, multi-platform bot adapters, and community tooling.
...
**Current upstream target**: v1.8.x (commit a4cea91, 2026-06-15).
