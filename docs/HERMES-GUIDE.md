...
(synced to v1.8.x), the DeepSeek-native AI coding agent. Reasonix itself is a
...
<p align="center">
  <sub>Reasonix Hermes — built on <a href="https://github.com/esengine/deepseek-reasonix">esengine/deepseek-reasonix</a> v1.8.x</sub>
  <br/>
